...
public class ShopInfoVO {
	...
	public int img_no;
	public int shop_limit;
	public int shop_promo;
	
	public ShopInfoVO() {
		
	}

	public ShopInfoVO(int shop_no, String shop_name, String shop_content, int shop_price, int shop_cnt,
	...
	public String toString() {
		return "ShopInfoVO [shop_no=" + shop_no + ", shop_name=" + shop_name + ", shop_content=" + shop_content
